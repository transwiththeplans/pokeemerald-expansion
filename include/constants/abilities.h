...
enum __attribute__((packed)) Ability
{
    ...
    //custom
    ABILITY_FOSSILIZE = 311,
    ABILITY_GRAVITY_WELL = 312,
    ABILITY_COUNTERPROOF = 313,
    ABILITY_EMANATE = 314,
    ABILITY_SNOW_SPEW = 315,
    ABILITY_SCARE = 316,
    ABILITY_MIST_CALLER = 317,
    ABILITY_WIND_BLOWER = 318,
    ABILITY_MATTER_ABSORB = 319,
    ABILITY_LOOSE_ROCKS = 320,
    ABILITY_FIREPOWER = 321,
    ABILITY_GARDENER = 322,
    ABILITY_WATERWORKER = 323,
    ABILITY_PERMAFROST = 324,
    ABILITY_DRAGONHEART = 325,
    ABILITY_PIXIECRAFT = 326,
    ABILITY_INSULATED = 327,
    ABILITY_CURL_UP = 328,
    ABILITY_FILTH_FEEDER = 329,
    ABILITY_REFRACTION = 330,
    ABILITY_BLACK_HOLE = 331,
    ABILITY_HUBRIS = 332,
    ABILITY_CRYONICS = 333,
    ABILITY_METAL_MUNCHER = 334,
    ABILITY_VANTABLACK = 335,
    ABILITY_METAL_MORPH = 336,
    ABILITY_ENERGY_EATER = 337,
    ABILITY_SOUL_FEED = 338,
    ABILITY_JUGGERNAUT = 339,
    ABILITY_CHROME_COAT = 340,
    ABILITY_SELF_SUFFICIENT = 341,
    ABILITY_TIME_WARP = 342,
    ABILITY_RAPID_FIRE = 343,
    ABILITY_WEB_DOWN = 344,
    ABILITY_IMMOLATE = 345,
    ABILITY_BELLICUS = 346,
    ABILITY_SERENA = 347,
    ABILITY_DEAD_SPACE = 348,
    ABILITY_POWER_METAL = 349,
    ABILITY_STAR_POWER = 350,
    ABILITY_SPECIALIST = 351,
    ABILITY_SHADOW_POWER = 352,
    ABILITY_DOPPLER_EFFECT = 353,
    ABILITY_SEED_DISPERSAL = 354,
    ABILITY_HEAT_LIGHTNING = 355,
    ABILITY_COLD_CURRENT = 356,
    ABILITY_AERODYNAMICS = 357,
    ABILITY_AIRBORNE = 358,
    ABILITY_TYPHOON = 359,
    ABILITY_BLOW_AWAY = 360,
    ABILITY_GENIUS = 361,
    ABILITY_FUSION_POWER = 362,
    ABILITY_PREDATOR = 363,
    ABILITY_IMPENETRABLE = 364,
    ABILITY_ALGAE_BLOOM = 365,
    ABILITY_AURA_SHIFT = 366,
    ABILITY_SPECTRALIZE = 367,
    ABILITY_SHOOTING_STAR = 368,
    ABILITY_DREAM_WORLD = 369,
    ABILITY_ROOTED = 370,
    ABILITY_OPPOSITE_DAY = 371,
    ABILITY_TOTTERING_STEP = 372,
    ABILITY_MOUNTAINEER = 373,
    ABILITY_CHEMIST = 374,
    ABILITY_ENCHANTING_VOICE = 375,
    ABILITY_DRAGONIZE = 376,
    ABILITY_MEGA_SOL = 377,
    ABILITY_MUCUS_MEMBRANE = 378,
    ABILITY_METAL_SHRED = 379,
    ABILITY_THERIANTROPE = 380,
    ABILITY_EELEVATE = 381,
    ABILITY_FIRE_MANE = 382,
    ABILITY_COLD_STORAGE = 383,
    ABILITY_BACKFIRE = 384,

    ABILITIES_COUNT_CUSTOM = 500,
