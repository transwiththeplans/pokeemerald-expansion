...
const struct Tileset gTileset_PetalburgRevamp =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_PetalburgRevamp,
    .palettes = gTilesetPalettes_PetalburgRevamp,
    .metatiles = gMetatiles_PetalburgRevamp,
    .metatileAttributes = gMetatileAttributes_PetalburgRevamp,
    .callback = NULL,
};

const struct Tileset gTileset_Mauville_Inside =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Mauville_Inside,
...
const struct Tileset gTileset_Mauville_Rooftop =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Mauville_Rooftop,
    .palettes = gTilesetPalettes_Mauville_Rooftop,
    .metatiles = gMetatiles_Mauville_Rooftop,
    .metatileAttributes = gMetatileAttributes_Mauville_Rooftop,
    .callback = NULL,
};
...
const struct Tileset gTileset_Mauville_Desert =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Mauville_Desert,
    .palettes = gTilesetPalettes_Mauville_Desert,
    .metatiles = gMetatiles_Mauville_Desert,
    .metatileAttributes = gMetatileAttributes_Mauville_Desert,
    .callback = NULL,
};

const struct Tileset gTileset_Mauville_Buildings =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Mauville_Buildings,
    .palettes = gTilesetPalettes_Mauville_Buildings,
    .metatiles = gMetatiles_Mauville_Buildings,
