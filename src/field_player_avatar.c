...
static const u16 sPlayerAvatarGfxIds_Alternate[][GENDER_COUNT] =
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_BRENDAN2_NORMAL,     OBJ_EVENT_GFX_MAY2_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_BRENDAN2_MACH_BIKE,  OBJ_EVENT_GFX_MAY2_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_BRENDAN2_ACRO_BIKE,  OBJ_EVENT_GFX_MAY2_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_BRENDAN2_SURFING,    OBJ_EVENT_GFX_MAY2_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_BRENDAN2_UNDERWATER, OBJ_EVENT_GFX_MAY2_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_BRENDAN2_FIELD_MOVE, OBJ_EVENT_GFX_MAY2_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_BRENDAN2_FISHING,    OBJ_EVENT_GFX_MAY2_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_BRENDAN2_WATERING,   OBJ_EVENT_GFX_MAY2_WATERING},
    [PLAYER_AVATAR_STATE_VSSEEKER]   = {OBJ_EVENT_GFX_BRENDAN2_FIELD_MOVE, OBJ_EVENT_GFX_MAY2_FIELD_MOVE},
};
...
{
    u8 costumeNum = VarGet(VAR_COSTUME_NUM);
    switch(costumeNum){
        case 1:
            return sPlayerAvatarGfxIds_Alternate[state][gender];
        break;
    }
