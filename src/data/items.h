...
// Medicine
    ...
    {
        .name = _("Burn Heal"),
        .price = (I_PRICE == GEN_7) ? 3 : ((I_PRICE <= GEN_7) ? 250 : 2),
        .description = COMPOUND_STRING(
            "Heals Pokémon\n"
            "of a burn."),
        .pocket = POCKET_ITEMS,
    ...
    {
        .name = _("Ice Heal"),
        .price = (I_PRICE == GEN_7) ? 1 : ((I_PRICE <= GEN_7) ? 250 : 2),
        .description = COMPOUND_STRING(
            "Defrosts a frozen\n"
            "Pokémon."),
        .pocket = POCKET_ITEMS,
    ...
    {
        .name = _("Awakening"),
        .price = (I_PRICE >= GEN_2 && I_PRICE <= GEN_6) ? 2 : ((I_PRICE == GEN_7) ? 100 : 2),
        .description = COMPOUND_STRING(
            "Awakens a sleeping\n"
            "Pokémon."),
        .pocket = POCKET_ITEMS,
...
// Vitamins
    ...
    {
        .name = _("PP Up"),
        .price = (I_PRICE == GEN_1) ? 1 : ((I_PRICE >= GEN_7) ? 10000 : 98),
        .description = COMPOUND_STRING(
            "Raises the maximum\n"
            "PP of a selected\n"
            "move."),
...
// Memories
    ...
    [ITEM_NORMAL_MEMORY] =
    {
        ...
        .flingPower = 50,
        .iconPic = gItemIcon_NormalMemory,
        .iconPalette = gItemIconPalette_NormalMemory,
    },
...
// Mega Stones
    ...
    [ITEM_ULTIMATRIX_SYMBOL] =
    {
        .name = _("Ultimatrix Symbol"),
        .price = 0,
    ...
    [ITEM_ULTIMATRIX_SYMBOL_MK2] =
    {
        .name = _("Ultimatrix Symbol 2"),
        .price = 0,
        .holdEffect = HOLD_EFFECT_MEGA_STONE,
        .description = COMPOUND_STRING(
            "This device enables\n"
    ...
    [ITEM_ULTIMATRIX_SYMBOL_Z] =
    {
        .name = _("Ultimatrix Symbol Z"),
        .price = 0,
        .holdEffect = HOLD_EFFECT_MEGA_STONE,
        .description = COMPOUND_STRING(
            "This device enables\n"
...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM_ASTEROID_BELT] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_ASTEROID_BELT,
    },
    ...
    [ITEM_TM_CHAIN_LIGHTNING] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_CHAIN_LIGHTNING,
    },
    ...
    [ITEM_TM_DIFFUSE_RAY] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_DIFFUSE_RAY,
    },

    [ITEM_TM_FLASH_VOLLEY] =
    {
        .name = _("TM104"),
        .price = 500,
        .description = COMPOUND_STRING(
