...
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_PROBOPASS_MEGA, ITEM_ULTIMATRIX_SYMBOL_Z},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sRotomFormChangeTable[] =
{
    ...
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_ROTOM_SMACK,   ITEM_ROTOM_CATALOG, 1},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_ROTOM_BOOGIE,  ITEM_ROTOM_CATALOG, 2},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_ROTOM_BFS,     ITEM_ROTOM_CATALOG, 3},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_ROTOM_SLAM,    ITEM_ROTOM_CATALOG, 4},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_ROTOM_BUST,    ITEM_ROTOM_CATALOG, 5},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_ROTOM_RIDE,    ITEM_ROTOM_CATALOG, 6},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_ROTOM_CASTER,  ITEM_ROTOM_CATALOG, 7},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_ROTOM_CHUCKS,  ITEM_ROTOM_CATALOG, 8},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_ROTOM_AXE,     ITEM_ROTOM_CATALOG, 9},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_ROTOM_BLOCKER, ITEM_ROTOM_CATALOG, 10},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_ROTOM_SLYDER,  ITEM_ROTOM_CATALOG, 11},
    {FORM_CHANGE_TERMINATOR},
};
