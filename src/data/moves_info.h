...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_ROCK_WRECKER] =
    {
        ...
        .description = COMPOUND_STRING(
            "Launches a massive boulder.\n"
            "Harshly lowers physical side."),
        .effect = EFFECT_HIT,
        .power = 150,
        .type = TYPE_ROCK,
        .accuracy = 90,
    ...
    [MOVE_PHANTOM_FORCE] =
    {
        .name = COMPOUND_STRING("Phantom Dive"),
        .description = sShadowForceDescription,
        .effect = EFFECT_SEMI_INVULNERABLE,
        .power = 90,
        .type = TYPE_GHOST,
    ...
    [MOVE_NOXIOUS_TORQUE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Revs up engine and slams\n"
            "into target. May poison."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_POISON,
        .accuracy = 100,
	...
	[MOVE_ASTEROID_BELT] =
	{
		.name = COMPOUND_STRING("Asteroid Belt"),
		.description = COMPOUND_STRING(
			"Pummels all foes with cosmic rocks.\n"
			"30% chance to burn."),
		.effect = EFFECT_HIT,
		.power = 90,
		.type = TYPE_ROCK,
	...
	[MOVE_BLOCK_BARRAGE] =
	{
		.name = COMPOUND_STRING("Block Barrage"),
		.description = COMPOUND_STRING(
			"Hurls blocks at the foe\n"
			"2 to 5 times in a row."),
		.effect = EFFECT_MULTI_HIT,
		.power = 25,
		.type = TYPE_NORMAL,
	...
	{
		.name = COMPOUND_STRING("Chain Lightning"),
		.description = COMPOUND_STRING(
			"Zaps the foe 2 to 5 times\n"
			"with chaining electricity."),
		.effect = EFFECT_MULTI_HIT,
		.power = 25,
		.type = TYPE_ELECTRIC,
		.accuracy = 90,
	...
	{
		.name = COMPOUND_STRING("Combination Strike"),
		.description = COMPOUND_STRING(
			"Cycles through DNA codes\n"
			"2 to 5 times in a row."),
		.effect = EFFECT_MULTI_HIT,
		.power = 25,
		.type = TYPE_NORMAL,
	...
	[MOVE_CURSED_TEMPLE] =
	{
		.name = COMPOUND_STRING("Cursed Temple"),
		.description = COMPOUND_STRING(
			"Echoes of ruin rise.\n"
			"Always traps the foe."),
		.effect = EFFECT_HIT,
		.power = 90,
		.type = TYPE_GHOST,
		.accuracy = 100,
    ...
    [MOVE_EYE_BLAST] =
    {
        .name = COMPOUND_STRING("Eye Blast"),
        .description = COMPOUND_STRING(
            "Fires 3 optic blasts.\n"
            "May burn/para/frostbite."),
        .effect = EFFECT_TRIPLE_KICK,
        .power = 15,
        .type = TYPE_NORMAL,
    ...
    [MOVE_FANGS_OF_STEEL] =
    {
        .name = COMPOUND_STRING("Fangs of Steel"),
        .description = COMPOUND_STRING(
            "Bites with steel fangs.\n"
            "May cause flinching."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_STEEL,
    ...
    [MOVE_FRENZY] =
    {
        .name = COMPOUND_STRING("Frenzy"),
        .description = COMPOUND_STRING(
            "Frenzied barrage that\n"
	...
	[MOVE_SOUL_SUCK] =
    {
        .name = COMPOUND_STRING("Soul Suck"),
        .description = COMPOUND_STRING(
            "Siphons energy to restore\n"
            "HP by half the damage."),
        .effect = EFFECT_ABSORB,
        .power = 60,
        .type = TYPE_GHOST,
        .accuracy = 95,
    ...
    [MOVE_STALAG_BITE] =
    {
        .name = COMPOUND_STRING("Stalag-bite"),
        .description = COMPOUND_STRING(
            "Bites with rocky fangs.\n"
            "May cause flinching."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_ROCK,
    ...
    [MOVE_NEUROSHOCK] =
    {
        .name = COMPOUND_STRING("Neuroshock"),
        .description = COMPOUND_STRING(
            "Shoots eye beams at the foe.\n"
            "May inflict a burn."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_ELECTRIC,
    ...
    [MOVE_TITAN_FANG] =
    {
        .name = COMPOUND_STRING("Titan Fang"),
        .description = COMPOUND_STRING(
            "Bites viciously. May lower\n"
            "the target's Speed."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_DRAGON,
    ...
    [MOVE_WALL_OF_SOUND] =
    {
        .name = COMPOUND_STRING("Wall of Sound"),
        .description = COMPOUND_STRING(
            "Screams repeatedly. Power\n"
            "increases each hit."),
        .effect = EFFECT_FURY_CUTTER,
        .power = 40,
        .type = TYPE_NORMAL,
    ...
    [MOVE_WEB_SWING] =
    {
        .name = COMPOUND_STRING("Web Swing"),
        .description = COMPOUND_STRING(
            "A swinging attack with a\n"
            "high critical-hit ratio."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_BUG,
	    ...
	    [MOVE_GLIMMER_GATE] =
    {
        .name = COMPOUND_STRING("Glimmer Gate"),
        .description = COMPOUND_STRING(
            "Portals an attack to 2\n"
            "turns later. Ignores Protect."),
        .effect = EFFECT_FUTURE_SIGHT,
        .power = 120,
        .type = TYPE_FAIRY,
        .accuracy = 100,
    ...
    [MOVE_HIT_AND_RUN] =
    {
        .name = COMPOUND_STRING("Hit & Run"),
        .description = COMPOUND_STRING(
            "Hits and lets the user\n"
            "switch out."),
        .effect = EFFECT_HIT_ESCAPE,
        .power = 70,
        .type = TYPE_DARK,
    ...
    [MOVE_INFEST_FIST] =
    {
        .name = COMPOUND_STRING("Infest Fist"),
        .description = COMPOUND_STRING(
            "Punch that may trap\n"
            "the foe."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_MAGNETIC_ROCKS] =
    {
        .name = COMPOUND_STRING("Magnetic Rocks"),
        .description = COMPOUND_STRING(
            "Magnetizes rocks that\n"
            "strike without fail."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_ROCK,
    ...
    [MOVE_MOMENTUM_PUNCH] =
    {
        .name = COMPOUND_STRING("Momentum Punch"),
        .description = COMPOUND_STRING(
            "Swift punch with a high\n"
            "critical-hit ratio."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_FLYING,
    ...
    [MOVE_PHASE] =
    {
        .name = COMPOUND_STRING("Phase"),
        .description = COMPOUND_STRING(
            "Hits and switches out\n"
            "the user."),
        .effect = EFFECT_HIT_ESCAPE,
        .power = 70,
        .type = TYPE_GHOST,
    ...
    [MOVE_QUAD_HIT] =
    {
        .name = COMPOUND_STRING("Quad Hit"),
        .description = COMPOUND_STRING(
            "Hits exactly 4 times\n"
            "in a row."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_FIGHTING,
    ...
    [MOVE_QUAKE_KICK] =
    {
        .name = COMPOUND_STRING("Quake Kick"),
        .description = COMPOUND_STRING(
            "Powerful kick that\n"
            "lowers Defense."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_ROCK_RIPPLE] =
    {
        .name = COMPOUND_STRING("Rock Ripple"),
        .description = COMPOUND_STRING(
            "Levitates a small rock\n"
            "to strike the foe."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_ROCK,
    ...
    [MOVE_SAP_FANG] =
    {
        .name = COMPOUND_STRING("Sap Fang"),
        .description = COMPOUND_STRING(
            "Bites with vicious fangs.\n"
            "Drains half the damage dealt."),
        .effect = EFFECT_ABSORB,
        .power = 70,
        .type = TYPE_GRASS,
        .accuracy = 100,
    ...
    [MOVE_SCARAB_LANCER] =
    {
        .name = COMPOUND_STRING("Scarab Lancer"),
        .description = COMPOUND_STRING(
            "Pierces with swift strikes.\n"
            "30% chance to raise user's Attack."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_FLYING,
        .accuracy = 100,
	    ...
	    [MOVE_SHARP_SHOOTING] =
    {
        .name = COMPOUND_STRING("Sharp Shooting"),
        .description = COMPOUND_STRING(
            "Icy projectiles that\n"
            "never miss."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_ICE,
    ...
    [MOVE_SHOCK_COLLAPSE] =
    {
        .name = COMPOUND_STRING("Shock Collapse"),
        .description = COMPOUND_STRING(
            "Electrified weight slams the foe.\n"
            "May paralyze."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_ELECTRIC,
    ...
    [MOVE_SHOULDER_CHARGE] =
    {
        .name = COMPOUND_STRING("Shoulder Charge"),
        .description = COMPOUND_STRING(
            "Shoulder attack with recoil."),
        .effect = EFFECT_RECOIL,
        .power = 120,
        .type = TYPE_DRAGON,
        .accuracy = 100,
    ...
    [MOVE_TERRA_SHATTER] =
    {
        .name = COMPOUND_STRING("Terra Shatter"),
        .description = COMPOUND_STRING(
            "Breaks the ground beneath\n"
            "the foe."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_ROCK,
    ...
    [MOVE_THUNDER_BALL] =
    {
        .name = COMPOUND_STRING("Thunder Ball"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CRATER_KICK] =
    {
        .name = COMPOUND_STRING("Crater Kick"),
        .description = COMPOUND_STRING(
            "Kicks the ground to form\n"
            "a crater."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_ROCK,
    ...
    [MOVE_VIRTUAL_SCREEN] =
    {
        .name = COMPOUND_STRING("Virtual Screen"),
        .description = COMPOUND_STRING(
            "Creates a screen of light\n"
            "to lower damage."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_ELECTRIC,
    ...
    [MOVE_VAMPIRE_FANGS] =
    {
        .name = COMPOUND_STRING("Vampire Fangs"),
        .description = COMPOUND_STRING(
            "Bites the foe to drain\n"
            "their vitality."),
        .effect = EFFECT_ABSORB,
        .power = 75,
        .type = TYPE_GHOST,
        ...
        .metronomeBanned = TRUE,
		.bitingMove = TRUE,
        .argument = { .absorbPercentage = 70 },
        .battleAnimScript = gBattleAnimMove_LeechLife,
    },

    [MOVE_SNOW_BURST] =
    {
        .name = COMPOUND_STRING("Snow Burst"),
        .description = COMPOUND_STRING(
            "A flurry of icy blasts\n"
    ...
    [MOVE_TRIPLE_MACE] =
    {
        .name = COMPOUND_STRING("Triple Mace"),
        .description = COMPOUND_STRING(
            "Hits with three flaming\n"
            "strikes."),
        .effect = EFFECT_MULTI_HIT,
        .power = 33,
        .type = TYPE_FIRE,
    ...
    [MOVE_FLASH_VOLLEY] =
    {
        .name = COMPOUND_STRING("Flash Volley"),
        .description = COMPOUND_STRING(
            "Fires off a barrage of\n"
            "steel shots."),
        .effect = EFFECT_MULTI_HIT,
        .power = 25,
        .type = TYPE_STEEL,
	...
	[MOVE_DIFFUSE_RAY] =
    {
        .name = COMPOUND_STRING("Diffuse Ray"),
        .description = COMPOUND_STRING(
            "Fires a scattering blast that\n"
            "may confuse the foe."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_NORMAL,
	...
	[MOVE_EARTH_BOMB] =
    {
        .name = COMPOUND_STRING("Earth Bomb"),
        .description = COMPOUND_STRING(
            "A life-risking slam that\n"
            "also hurts the user."),
        .effect = EFFECT_RECOIL,
        .power = 120,
        .type = TYPE_GROUND,
    ...
    [MOVE_WHALE_CALL] =
    {
        .name = COMPOUND_STRING("Whale Call"),
        .description = COMPOUND_STRING(
            "A booming call ripples\n"
			"through. May raise SpA."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_FALLING_STAR] =
    {
        .name = COMPOUND_STRING("Falling Star"),
        .description = COMPOUND_STRING(
            "A falling star hits.\n"
            "Lowers Sp. Def."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_REALITY_WARP] =
    {
        .name = COMPOUND_STRING("Reality Warp"),
        .description = COMPOUND_STRING(
            "Warps reality to attack.\n"
    ...
    [MOVE_SPACE_WARP] =
    {
        .name = COMPOUND_STRING("Space Warp"),
        .description = COMPOUND_STRING(
            "Warps space to attack.\n"
            "Breaks through Protect."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_PSYCHIC,
	...
	[MOVE_HOLY_FLAME] =
    {
        .name = COMPOUND_STRING("Holy Flame"),
        .description = COMPOUND_STRING(
            "Attacks with a pure flame.\n"
            "Drains half the damage dealt."),
        .effect = EFFECT_ABSORB,
        .power = 70,
        .type = TYPE_FIRE,
	    ...
	    [MOVE_KINDLING] =
    {
	    ...
	    [MOVE_BRAINSTORM] =
    {
        .name = COMPOUND_STRING("Brainstorm"),
        .description = COMPOUND_STRING(
            "Projects a thought that raises\n"
            "the user's Special Attack."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_PSYCHIC,
	...
	[MOVE_AURA_CHARGE] =
    {
        .name = COMPOUND_STRING("Aura Charge"),
        .description = COMPOUND_STRING(
            "Focuses its aura and attacks.\n"
	...
	[MOVE_ALKALIZING] =
    {
        .name = COMPOUND_STRING("Alkalizing"),
        .description = COMPOUND_STRING(
            "Raises its pH to\n"
            "sharply boost Sp. Def."),
        .effect = EFFECT_SPECIAL_DEFENSE_UP_2,
        .power = 0,
        .type = TYPE_POISON,
        .accuracy = 0,
	...
	[MOVE_SPIRIT_HAMMER] =
    {
        .name = COMPOUND_STRING("Spirit Hammer"),
        .description = COMPOUND_STRING(
            "A s-risking tackle that\n"
            "also hurts the user."),
        .effect = EFFECT_RECOIL,
        .power = B_UPDATED_MOVE_DATA >= GEN_2 ? 120 : 100,
        .type = TYPE_NORMAL,
