...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_EFFECT_SPORE, ABILITY_POISON_HEAL, ABILITY_FILTH_FEEDER },
    #else
	...
	[SPECIES_ARON] =
	{
		...
		.abilities = { ABILITY_ARENA_TRAP, ABILITY_IRON_FIST, ABILITY_EARTH_EATER },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Aron"),
        .cryId = CRY_ARON,
    ...
    [SPECIES_MILOTIC] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MIST_CALLER, ABILITY_NONE, ABILITY_MULTISCALE },
    #else
