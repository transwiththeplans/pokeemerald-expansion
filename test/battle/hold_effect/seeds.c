...
SINGLE_BATTLE_TEST("Electric Seed raises the holder's Defense on Electric Terrain (Trait)")
{
    u32 ability, item;
    PARAMETRIZE { ability = ABILITY_TELEPATHY; item = ITEM_NONE; }
    PARAMETRIZE { ability = ABILITY_TELEPATHY; item = ITEM_ELECTRIC_SEED; }
...
SINGLE_BATTLE_TEST("Grassy Seed raises the holder's Defense on Grassy Terrain (Trait)")
{
    u32 ability, item;
    PARAMETRIZE { ability = ABILITY_TELEPATHY; item = ITEM_NONE; }
    PARAMETRIZE { ability = ABILITY_TELEPATHY; item = ITEM_GRASSY_SEED; }
...
SINGLE_BATTLE_TEST("Misty Seed raises the holder's Sp. Defense on Misty Terrain (Trait)")
{
    u32 ability, item;
    PARAMETRIZE { ability = ABILITY_TELEPATHY; item = ITEM_NONE; }
    PARAMETRIZE { ability = ABILITY_TELEPATHY; item = ITEM_MISTY_SEED; }
...
SINGLE_BATTLE_TEST("Psychic Seed raises the holder's Sp. Defense on Psychic Terrain (Trait)")
{
    u32 ability, item;
    PARAMETRIZE { ability = ABILITY_TELEPATHY; item = ITEM_NONE; }
    PARAMETRIZE { ability = ABILITY_TELEPATHY; item = ITEM_PSYCHIC_SEED; }
...
SINGLE_BATTLE_TEST("Seeds get consumed in Terrain even if holder is not affected by Terrain (Trait)")
{
...
SINGLE_BATTLE_TEST("Electric Seed is consumed on Electric Terrain before other abilities change the terrain (Trait)")
{
    GIVEN {
...
SINGLE_BATTLE_TEST("Electric Seed doesn't activate on existing Electric Terrain before user's ability changes the terrain (Trait)")
{
    GIVEN {
        PLAYER(SPECIES_WOBBUFFET);
