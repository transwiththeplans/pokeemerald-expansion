...
extern const struct SpriteTemplate gFieldEffectObjectTemplate_DarkSandFootprints;
...
const struct SpriteTemplate *const gFieldEffectObjectTemplatePointers[] = {
    ...
    [FLDEFFOBJ_DARK_SAND_FOOTPRINTS]  = &gFieldEffectObjectTemplate_DarkSandFootprints,
