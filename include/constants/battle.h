...
#define VOLATILE_DEFINITIONS(F) \
    ...
    F(VOLATILE_AIRBORNE,                    airborne,                      (u32, 1))
...
enum ChemistEffects
{
    CHEMIST_EFFECT_POISON,
    CHEMIST_EFFECT_SLEEP,
    CHEMIST_EFFECT_BURN,
    CHEMIST_EFFECT_FROSTBITE,
    CHEMIST_EFFECT_PARALYSIS,
    CHEMIST_EFFECT_CONFUSION,
    CHEMIST_EFFECT_INFATUATION,
    CHEMIST_EFFECT_TAUNT,
    CHEMIST_EFFECT_TORMENT,
    NUM_CHEMIST_EFFECTS,
};
