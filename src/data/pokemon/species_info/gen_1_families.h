...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .description = COMPOUND_STRING(
            "Bulbasaur can be seen napping in dank\n"
            "swamps. There is a weed on its back.\n"
            "By soaking up methane below, the weed\n"
        ...
        .backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 16 : 5,
    ...
    [SPECIES_IVYSAUR] =
    {
        ...
        .weight = 130,
        .description = COMPOUND_STRING(
            "As it starts to bloom, Ivysaur’s legs grow\n"
            "sturdy. If it manages to absorb enough\n"
            "methane, the bloom will soon begin to\n"
            "burn like fire."),
        .pokemonScale = 335,
        .pokemonOffset = 13,
        .trainerScale = 256,
    ...
    [SPECIES_VENUSAUR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_OVERGROW, ABILITY_REGENERATOR, ABILITY_FLASH_FIRE },
        .innates = { ABILITY_SEED_SOWER },
        .innateUnlockLevel = 25,
        .bodyColor = BODY_COLOR_GREEN,
        ...
        .weight = 1000,
        .description = COMPOUND_STRING(
            "Now fully blossomed, Venusaur can control\n"
            "every plant in its surroundings. Its vines\n"
            "have a flame on the tip, leaving burn\n"
            "scars on any foe it strikes."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 388,
        .trainerOffset = 6,
    ...
    [SPECIES_VENUSAUR_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_SEED_DISPERSAL, ABILITY_SEED_DISPERSAL, ABILITY_SEED_DISPERSAL },
        .innates = { ABILITY_FIREPOWER },
        .innateUnlockLevel = 25,
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Venusaur"),
    ...
    [SPECIES_CHARMANDER] =
    {
        ...
        .abilities = { ABILITY_SCARE, ABILITY_ICE_SCALES, ABILITY_MULTISCALE },
		.innates = {ABILITY_SNOW_SPEW},
		.innateUnlockLevel = 0,
    ...
    [SPECIES_CHARIZARD_MEGA_Z] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_IMMOLATE, ABILITY_IMMOLATE, ABILITY_IMMOLATE },
    ...
    [SPECIES_SQUIRTLE] =
    {
        ...
        .abilities = { ABILITY_CURL_UP, ABILITY_CLOUD_NINE, ABILITY_BULLETPROOF },
    ...
    [SPECIES_BLASTOISE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_EMANATE, ABILITY_EMANATE, ABILITY_EMANATE },
        .innates = {ABILITY_SHELL_ARMOR}, 
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Blastoise"),
    ...
    [SPECIES_BLASTOISE_MEGA_Y] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_FIREPOWER, ABILITY_FIREPOWER, ABILITY_FIREPOWER },
        .innates = {ABILITY_SHELL_ARMOR}, 
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Blastoise"),
        .cryId = CRY_BLASTOISE_MEGA,
    ...
    [SPECIES_CATERPIE] =
    {
        ...
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_TINTED_LENS, ABILITY_RUN_AWAY },
        .innates = { ABILITY_MAGIC_GUARD },
        .innateUnlockLevel = 10,
        .bodyColor = BODY_COLOR_GREEN,
        ...
        .weight = 29,
        .description = COMPOUND_STRING(
            "Some people keep Caterpie as pets to help\n"
            "with insomnia. Its gentle scent resembles\n"
            "peppermint and is naturally soothing to\n"
            "those nearby."),
        .pokemonScale = 549,
        .pokemonOffset = 22,
        .trainerScale = 256,
        ...
        .backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 15 : 6,
    ...
    [SPECIES_METAPOD] =
    {
        ...
        .weight = 99,
        .description = COMPOUND_STRING(
            "Inside the shell, the pupa feeds on the\n"
            "dreams of others. This borrowed energy\n"
            "nurtures it as it prepares for its\n"
            "future evolution."),
        .pokemonScale = 350,
        .pokemonOffset = 18,
        .trainerScale = 256,
    ...
    [SPECIES_BUTTERFREE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_TINTED_LENS, ABILITY_FRIEND_GUARD },
        .innates = { ABILITY_MAGIC_GUARD },
        .innateUnlockLevel = 10,
        ...
        .weight = 320,
        .description = COMPOUND_STRING(
            "Butterfree fly quietly at night. Leave a\n"
            "window open, and you may awake having had\n"
            "an unusually restful sleep. Its powder is\n"
        ...
        .backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 6 : 3,
    ...
    [SPECIES_BUTTERFREE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_DREAM_WORLD, ABILITY_DREAM_WORLD, ABILITY_DREAM_WORLD },
        .innates = { ABILITY_MAGIC_GUARD },
        .innateUnlockLevel = 10,
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Butterfree"),
    ...
    [SPECIES_WEEDLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_STENCH, ABILITY_RUN_AWAY },
        .innates = { ABILITY_CORROSION },
        .innateUnlockLevel = 10,
        ...
        .weight = 32,
        .description = COMPOUND_STRING(
            "Weedle’s stench is unmatched among the\n"
            "region’s insects. Some cities enforce\n"
            "strict ordinances to keep Weedle\n"
            "populations away."),
        .pokemonScale = 455,
        .pokemonOffset = 22,
        .trainerScale = 256,
    ...
    [SPECIES_KAKUNA] =
    {
        ...
        .weight = 100,
        .description = COMPOUND_STRING(
            "As a defense mechanism, it stores sticky\n"
            "fluids inside its shell. When threatened,\n"
            "it blasts the goo out to deter any\n"
            "predator that approaches."),
        .pokemonScale = 424,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define BEEDRILL_ATTACK (P_UPDATED_STATS >= GEN_6 ? 90 : 80)
    ...
    [SPECIES_BEEDRILL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_STENCH, ABILITY_MERCILESS },
        .innates = { ABILITY_CORROSION },
        .innateUnlockLevel = 10,
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .weight = 295,
        .description = COMPOUND_STRING(
            "Its tail is powerful enough to slice\n"
            "through metal. It fires balls of slime\n"
            "from its eyes to immobilize prey or\n"
...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_PICHU] =
    {
		...
		.innates = { ABILITY_HEAT_LIGHTNING}, 
		.innateUnlockLevel = 40,
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Pichu"),
        .cryId = CRY_PICHU,
        ...
        .backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 11 : 0,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
    ...
    [SPECIES_PIKACHU] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_FIRE_STONE, SPECIES_RAICHU},
                                {EVO_ITEM, ITEM_ICE_STONE, SPECIES_RAICHU_ALOLA}),
    },
...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    [SPECIES_RAICHU] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_LIGHTNING_ROD },
		.innates = { ABILITY_HEAT_LIGHTNING}, 
		.innateUnlockLevel = 40,
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .weight = 300,
        .description = COMPOUND_STRING(
            "It ignites its tail and rides it like a\n"
            "comet through the sky. Legends say ancient\n"
            "Raichu once used chunks of the earth\n"
            "itself to fly."),
        .pokemonScale = 426,
        .pokemonOffset = 13,
        .trainerScale = 256,
    ...
    [SPECIES_RAICHU_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_THICK_FAT, ABILITY_NONE, ABILITY_LIGHTNING_ROD },
		.innates = { ABILITY_COLD_CURRENT}, 
		.innateUnlockLevel = 40,
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Raichu"),
        .cryId = CRY_RAICHU,
    ...
    [SPECIES_SANDSHREW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PIXILATE, ABILITY_NONE, ABILITY_NATURAL_CURE },
		.innates = {ABILITY_CURL_UP},
        .innateUnlockLevel = 25,
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .weight = 120,
        .description = COMPOUND_STRING(
            "Unlike other variants, this Sandshrew\n"
            "burrows holes in space itself, warping\n"
            "short distances. Children adore riding\n"
            "its strange jumps."),
        .pokemonScale = 365,
        .pokemonOffset = 18,
        .trainerScale = 256,
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_SHINY_STONE, SPECIES_SANDSLASH}),
    },
    ...
    [SPECIES_SANDSLASH] =
    {
        ...
        .weight = 295,
        .description = COMPOUND_STRING(
            "With mastery over its warping power, it\n"
            "is theorized that Sandslash can open\n"
            "breaches to alternate dimensions and\n"
            "realities far beyond ours."),
        .pokemonScale = 341,
        .pokemonOffset = 11,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CLEFFA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_DAZZLING, ABILITY_MAGIC_GUARD, ABILITY_SERENE_GRACE },
		.innates = { ABILITY_TERA_SHELL}, 
		.innateUnlockLevel = 40,
    ...
    [SPECIES_VULPIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_IMMOLATE, ABILITY_DROUGHT },
		.innates = {ABILITY_PERISH_BODY},
		.innateUnlockLevel = 30,
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_VULPIX_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ICE_BODY, ABILITY_REFRIGERATE, ABILITY_SNOW_WARNING },
    ...
    #define JIGGLYPUFF_FAMILY_TYPES { TYPE_STEEL, TYPE_FAIRY}
#else
    ...
    [SPECIES_IGGLYBUFF] =
    {
        ...
        .backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 11 : 5,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
    ...
    [SPECIES_JIGGLYPUFF] =
    {
        ...
        .backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 13 : 5,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
...
#define WIGGLYTUFF_SP_ATK   50
    ...
    [SPECIES_PARAS] =
    {
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_STATIC, ABILITY_BATTLE_ARMOR, ABILITY_ELECTROMORPHOSIS },
    #else
        ...
        .weight = 54,
        .description = COMPOUND_STRING(
            "Paras is believed to be among the most\n"
            "intelligent Pokémon, with one study\n"
            "claiming questionably that it had an\n"
            "undecillion-level IQ."),
        .pokemonScale = 593,
        .pokemonOffset = 22,
        .trainerScale = 256,
        .trainerOffset = 0,
        ...
        .backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 20 : 0,
        .backAnimId = BACK_ANIM_H_SLIDE,
    ...
    [SPECIES_PARASECT] =
    {
        ...
        .weight = 295,
        .description = COMPOUND_STRING(
            "Parasect spends most of its days\n"
            "motionless, performing intricate mental\n"
            "calculations. Its hardened shell protects\n"
            "its delicate brain."),
        .pokemonScale = 307,
        .pokemonOffset = 8,
        .trainerScale = 256,
    ...
    [SPECIES_DIGLETT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLUFFY, ABILITY_ARENA_TRAP, ABILITY_SAND_FORCE },
		.innates = {ABILITY_TANGLING_HAIR},
		.innateUnlockLevel = 20,
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .weight = 8,
        .description = COMPOUND_STRING(
            "It sports peach fuzz beneath its nose.\n"
            "It is not exceptional in battle, but its\n"
            "charm has won over many young trainers\n"
            "who adore its mustache."),
        .pokemonScale = 833,
        .pokemonOffset = 25,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DUGTRIO] =
    {
        ...
        .weight = 333,
        .description = COMPOUND_STRING(
            "The Dugtrio with the fullest mustache is\n"
            "recognized as the leader. Many trainers\n"
            "style their Dugtrio’s facial hair just as\n"
            "they would a Furfrou."),
        .pokemonScale = 406,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MEOWTH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_UNAWARE, ABILITY_HUSTLE, ABILITY_SHARPNESS },
        ...
        .backPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(56, 56),
        .backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 12 : 3,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
    ...
    [SPECIES_PERRSERKER] =
    {
		...
		.formSpeciesIdTable = sPerrserkerFormSpeciesIdTable,
        .formChangeTable = sPerrserkerFormChangeTable,
    },
#endif //P_GALARIAN_FORMS

#if P_MEGA_EVOLUTIONS
    [SPECIES_PERRSERKER_MEGA] =
    {
        .baseHP        = 70,
        .baseAttack    = 150,
        .baseDefense   = 140,
    ...
    [SPECIES_PSYDUCK] =
    {
        ...
        .abilities = { ABILITY_SIMPLE, ABILITY_NONE, ABILITY_SCRAPPY },
        ...
        .weight = 196,
        .description = COMPOUND_STRING(
            "It suffers from constant headaches caused\n"
            "by the incompetence of those around it.\n"
            "When the pain spikes, it fires blasts of\n"
            "water from its fingertips."),
        .pokemonScale = 369,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GOLDUCK] =
    {
        ...
        .weight = 766,
        .description = COMPOUND_STRING(
            "All Golduck now mysteriously share the\n"
            "middle name 'Profit Danger Trouble.'\n"
            "Researchers have no explanation, and the\n"
            "phenomenon makes no sense at all."),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 273,
        .trainerOffset = 1,
    ...
    [SPECIES_MANKEY] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_VITAL_SPIRIT, ABILITY_QUICK_FEET, ABILITY_GORILLA_TACTICS },
    #else
        ...
        .categoryName = _("Spidermonkey"),
        .height = 5,
        .weight = 280,
        .description = COMPOUND_STRING(
            "It is extremely quick to startle and even\n"
            "quicker to anger. It will start swinging\n"
            "its limbs wildly at the drop of a hat."),
        .pokemonScale = 404,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PRIMEAPE] =
    {
        ...
        .weight = 320,
        .description = COMPOUND_STRING(
            "It becomes enraged when it sees an\n"
            "opponent's eyes, and even angrier when\n"
            "someone dares to look back. Its new pair\n"
            "of eyes makes this far more common."),
        .pokemonScale = 326,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_ANNIHILAPE}),
    },
    ...
    [SPECIES_ANNIHILAPE] =
    {
        ...
        .weight = 560,
        .description = COMPOUND_STRING(
            "Its fury unlocked power beyond the limits\n"
            "of its physical body. Researchers note\n"
            "this phenomenon is similar to Mega\n"
            "Evolution."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_POLIWAG] =
    {
        ...
        .abilities = { ABILITY_HYDRATION, ABILITY_DAMP, ABILITY_STAMINA },
    ...
    [SPECIES_POLIWRATH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_HYDRATION, ABILITY_IRON_FIST, ABILITY_STAMINA },
		.innates = {ABILITY_WATER_ABSORB},
		.innateUnlockLevel = 30,
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_POLITOED] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_HYDRATION, ABILITY_UNAWARE, ABILITY_DRIZZLE },
		.innates = {ABILITY_WATER_ABSORB},
		.innateUnlockLevel = 30,
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_ABRA] =
    {
        ...
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_TRACE, ABILITY_MAGIC_GUARD },
...
#define ALAKAZAM_SP_DEF 135
    ...
    [SPECIES_MACHOP] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_GUTS, ABILITY_PARENTAL_BOND, ABILITY_DEFIANT },
        ...
        .backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 12 : 7,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
    ...
    [SPECIES_TENTACOOL] =
    {
        ...
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_DRIZZLE, ABILITY_MAGIC_GUARD },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_TENTACRUEL}),
    },
...
#define GOLEM_ATTACK (P_UPDATED_STATS >= GEN_6 ? 120 : 110)
    ...
    [SPECIES_GEODUDE] =
    {
        ...
        .abilities = { ABILITY_STURDY, ABILITY_SKILL_LINK, ABILITY_REGENERATOR },
    ...
    [SPECIES_GEODUDE_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_CURSED_BODY, ABILITY_POISON_POINT, ABILITY_FOSSILIZE },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Geodude"),
        .cryId = CRY_GEODUDE,
        .natDexNum = NATIONAL_DEX_GEODUDE,
    ...
    [SPECIES_GRAVELER_ALOLA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_TRADE, 0, SPECIES_GOLEM_ALOLA},
                                {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_GOLEM_ALOLA}),
    },
    ...
    [SPECIES_SLOWPOKE] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 40,
        .types = MON_TYPES(TYPE_DRAGON, TYPE_NONE),
        .catchRate = 190,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_OWN_TEMPO, ABILITY_ARMOR_TAIL },
		.innates = {ABILITY_MULTISCALE},
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_DAWN_STONE, SPECIES_SLOWBRO},
                                {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_SLOWKING}),
    },
    ...
    [SPECIES_SLOWKING] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_OWN_TEMPO, ABILITY_ANGER_SHELL },
		.innates = {ABILITY_MULTISCALE},
		.innateUnlockLevel = 45, 
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_MAGNEMITE] =
    {
        ...
        .backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 20 : 14,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
    ...
    [SPECIES_MAGNEZONE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_MAGNET_PULL, ABILITY_FULL_METAL_BODY, ABILITY_ANALYTIC },
		.innates = {ABILITY_LEVITATE},
		.innateUnlockLevel = 20, 
        .bodyColor = BODY_COLOR_GRAY,
	...
	[SPECIES_MAGNEMITE_SEVII] =
	{
		...
		.growthRate = GROWTH_MEDIUM_FAST,
		.eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
		.abilities = { ABILITY_BATTERY, ABILITY_SCARE, ABILITY_REGENERATOR },
		...
		.trainerScale = 256,
		.trainerOffset = 0,
		.frontPic = gMonFrontPic_MagnemiteSevii,
		.frontPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(32, 24) : MON_COORDS_SIZE(48, 32),
		.frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 21 : 20,
		.frontAnimFrames = sAnims_SingleFramePlaceHolder,
		.frontAnimId = ANIM_TUMBLING_FRONT_FLIP_TWICE,
		.enemyMonElevation = P_GBA_STYLE_SPECIES_GFX ? 16 : 17,
		.backPic = gMonBackPic_MagnemiteSevii,
		.backPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(32, 24) : MON_COORDS_SIZE(48, 40),
		.backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 20 : 15,
		.backAnimId = BACK_ANIM_TRIANGLE_DOWN,
		.palette = gMonPalette_MagnemiteSevii,
		.shinyPalette = gMonShinyPalette_MagnemiteSevii,
		.iconSprite = gMonIcon_MagnemiteSevii,
		.iconPalIndex = 0,
		.pokemonJumpType = PKMN_JUMP_TYPE_NONE,
		SHADOW(-1, 8, SHADOW_SIZE_S)
		FOOTPRINT(MagnemiteSevii)
		OVERWORLD(
			sPicTable_Magnemite,
			SIZE_32x32,
			SHADOW_SIZE_M,
		...
		.isAlolanForm = TRUE,
		.levelUpLearnset = sMagnemiteSeviiLevelUpLearnset,
		.teachableLearnset = sMagnemiteSeviiTeachableLearnset,
		.formSpeciesIdTable = sMagnemiteFormSpeciesIdTable,
		.evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_MAGNETON_SEVII}),
	},
	...
	[SPECIES_MAGNETON_SEVII] =
	{
		...
		.trainerScale = 256,
		.trainerOffset = 0,
		.frontPic = gMonFrontPic_MagnetonSevii,
		.frontPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 56),
		.frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 8 : 7,
		.frontAnimFrames = sAnims_SingleFramePlaceHolder,
		.frontAnimId = ANIM_FLASH_YELLOW,
		.enemyMonElevation = P_GBA_STYLE_SPECIES_GFX ? 8 : 9,
		.backPic = gMonBackPic_MagnetonSevii,
		.backPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 56),
		.backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 10 : 9,
		.backAnimId = BACK_ANIM_TRIANGLE_DOWN,
		.palette = gMonPalette_MagnetonSevii,
		.shinyPalette = gMonShinyPalette_MagnetonSevii,
		.iconSprite = gMonIcon_MagnetonSevii,
		.iconPalIndex = 0,
		.pokemonJumpType = PKMN_JUMP_TYPE_NONE,
		SHADOW(0, 13, SHADOW_SIZE_M)
		FOOTPRINT(MagnetonSevii)
		OVERWORLD(
			sPicTable_Magneton,
			SIZE_32x32,
			SHADOW_SIZE_M,
		...
		.isAlolanForm = TRUE,
		.levelUpLearnset = sMagnetonSeviiLevelUpLearnset,
		.teachableLearnset = sMagnetonSeviiTeachableLearnset,
		.formSpeciesIdTable = sMagnetonFormSpeciesIdTable,
		.evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_MAGNESHOCKS}),
	},
	...
	[SPECIES_MAGNESHOCKS] =
	{
		...
		.trainerScale = 256,
		.trainerOffset = 0,
		.frontPic = gMonFrontPic_Magneshocks,
		.frontPicSize = MON_COORDS_SIZE(64, 56),
		.frontPicYOffset = 4,
		.frontAnimFrames = sAnims_SingleFramePlaceHolder,
		.frontAnimId = ANIM_H_SLIDE_WOBBLE,
		.enemyMonElevation = 4,
		.backPic = gMonBackPic_Magneshocks,
		.backPicSize = MON_COORDS_SIZE(64, 40),
		.backPicYOffset = 1,
		.backAnimId = BACK_ANIM_TRIANGLE_DOWN,
		.palette = gMonPalette_Magneshocks,
		.shinyPalette = gMonShinyPalette_Magneshocks,
		.iconSprite = gMonIcon_Magneshocks,
		.iconPalIndex = 0,
		.pokemonJumpType = PKMN_JUMP_TYPE_NONE,
		SHADOW(4, 11, SHADOW_SIZE_XL_BATTLE_ONLY)
		FOOTPRINT(Magneshocks)
		OVERWORLD(
			sPicTable_Magnezone,
			SIZE_32x32,
			SHADOW_SIZE_M,
		...
		.levelUpLearnset = sMagneshocksLevelUpLearnset,
		.teachableLearnset = sMagneshocksTeachableLearnset,
	},
#endif//P_ALOLAN_FORMS
...
#define FARFETCHD_ATTACK (P_UPDATED_STATS >= GEN_7 ? 90 : 65)
    ...
    [SPECIES_GRIMER] =
    {
        ...
        .abilities = { ABILITY_GALVANIZE, ABILITY_GOOEY, ABILITY_LIGHTNING_ROD },
    ...
    [SPECIES_GASTLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_GRAVITY_WELL, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_PURPLE,
...
#define GENGAR_ABILITIES {ABILITY_GRAVITY_WELL, ABILITY_NONE, ABILITY_NONE}
#else
#define GENGAR_ABILITIES {ABILITY_GRAVITY_WELL, ABILITY_NONE, ABILITY_NONE}
#endif
    ...
    [SPECIES_GENGAR_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_BLACK_HOLE, ABILITY_BLACK_HOLE, ABILITY_BLACK_HOLE },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Gengar"),
    ...
    [SPECIES_ONIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_MAGNET_PULL, ABILITY_CHROME_COAT },
    ...
    [SPECIES_VOLTORB] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_DOWNLOAD, ABILITY_AFTERMATH, ABILITY_ELECTRIC_SURGE },
		.innates = {ABILITY_VOLT_ABSORB},
		.innateUnlockLevel = 25,
        .bodyColor = BODY_COLOR_RED,
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_ELECTRODE}),
    },
    ...
    [SPECIES_VOLTORB_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_CURL_UP, ABILITY_AFTERMATH, ABILITY_GRASSY_SURGE },
		.innates = {ABILITY_VOLT_ABSORB},
		.innateUnlockLevel = 25,
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Voltorb"),
    ...
    [SPECIES_EXEGGCUTE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_SEED_SOWER, ABILITY_MAGIC_BOUNCE, ABILITY_CHLOROPHYLL },
    ...
    [SPECIES_EXEGGUTOR_ALOLA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_LONG_REACH, ABILITY_SKILL_LINK, ABILITY_CHLOROPHYLL },
		.innates = {ABILITY_HARVEST},
		.innateUnlockLevel = 40,
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Exeggutor"),
    ...
    [SPECIES_CUBONE] =
    {
        ...
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_BATTLE_ARMOR, ABILITY_STAMINA },
    ...
    [SPECIES_MAROWAK_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_CURSED_BODY, ABILITY_PERISH_BODY },
		.innates = {ABILITY_SKILL_LINK},
		.innateUnlockLevel = 40,
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Marowak"),
    ...
    [SPECIES_TYROGUE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_STEADFAST, ABILITY_STEADFAST, ABILITY_VITAL_SPIRIT },
    #else
    ...
    [SPECIES_HITMONLEE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_LIMBER, ABILITY_LIMBER, ABILITY_UNBURDEN },
    #else
    ...
    [SPECIES_HITMONCHAN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_IRON_FIST, ABILITY_IRON_FIST, ABILITY_NO_GUARD },
    #else
    ...
    [SPECIES_HITMONTOP] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_TECHNICIAN, ABILITY_TECHNICIAN, ABILITY_TANGLING_HAIR },
    #else
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LEVITATE, ABILITY_NEUTRALIZING_GAS, ABILITY_CHEMIST },
        .innates = {ABILITY_FILTH_FEEDER},
        .innateUnlockLevel = 40,
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_HAPPINY] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_WATER_ABSORB, ABILITY_NATURAL_CURE, ABILITY_UNAWARE },
        .bodyColor = BODY_COLOR_PINK,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_CHANSEY}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_TANGELA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_GRASS_PELT, ABILITY_COTTON_DOWN, ABILITY_WATER_COMPACTION },
    #else
        ...
        .weight = 350,
        .description = COMPOUND_STRING(
            "Its body resembles a compact mass of thin,\n"
            "flexible vines. It stretches them easily to\n"
            "lash wildly at any threat that approaches\n"
            "its territory."),
        .pokemonScale = 304,
        .pokemonOffset = 1,
        .trainerScale = 256,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_TANGROWTH}),
    },
    ...
    [SPECIES_TANGROWTH] =
    {
        ...
        .weight = 1286,
        .description = COMPOUND_STRING(
            "The seeds on its back work like ammunition.\n"
            "It fires them to stun prey while stretching\n"
            "its enormous body, strong enough to lift a\n"
            "full-sized car."),
        .pokemonScale = 261,
        .pokemonOffset = 1,
        .trainerScale = 334,
    ...
    [SPECIES_STARYU] =
    {
        ...
        .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 10 : 6,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_STARMIE}),
    },
    ...
    [SPECIES_STARMIE] =
    {
        ...
        .backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 14 : 0,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_BLUE,
    ...
    [SPECIES_STARMIE_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_STAR_POWER, ABILITY_NONE, ABILITY_NONE },
		.innates = {ABILITY_TERA_SHELL},
		.innateUnlockLevel = 50, 
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Starmie"),
	...
	[SPECIES_STARMIE_MEGA_Z] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_SHOOTING_STAR, ABILITY_NONE, ABILITY_NONE },
		.innates = {ABILITY_TERA_SHELL},
		.innateUnlockLevel = 50, 
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Starmie"),
    ...
    [SPECIES_MIME_JR] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_CURSED_BODY, ABILITY_OWN_TEMPO, ABILITY_SOUL_FEED },
    #else
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_MR_MIME, CONDITIONS({IF_KNOWS_MOVE, MOVE_DREAM_EATER})},
    ...
    [SPECIES_MR_MIME] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_CURSED_BODY, ABILITY_SCARE, ABILITY_SOUL_FEED },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_SCYTHER] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_TECHNICIAN, ABILITY_INNER_FOCUS, ABILITY_INTIMIDATE },
    #else
        ...
        .evolutions = EVOLUTION({EVO_TRADE, 0, SPECIES_SCIZOR, CONDITIONS({IF_HOLD_ITEM, ITEM_METAL_COAT})},
                                ...
                                {EVO_ITEM, ITEM_DRAGON_SCALE, SPECIES_SCIZOR}),
    },
    ...
    [SPECIES_SCIZOR] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_TECHNICIAN, ABILITY_STRONG_JAW, ABILITY_INTIMIDATE },
    #else
    ...
    [SPECIES_ELEKID] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_TRANSISTOR, ABILITY_MOXIE, ABILITY_SHEER_FORCE },
    ...
    [SPECIES_MAGBY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_FIREPOWER, ABILITY_HUBRIS, ABILITY_MEGA_LAUNCHER },
    ...
    [SPECIES_PINSIR] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_LIGHTNING_ROD, ABILITY_FLASH_FIRE, ABILITY_WATER_ABSORB },
    #else
    ...
    [SPECIES_MAGIKARP] =
    {
        ...
        .abilities = { ABILITY_LIMBER, ABILITY_NONE, ABILITY_DRAGONHEART },
        .innates = { ABILITY_HUBRIS},
		.innateUnlockLevel = 50,
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_GYARADOS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SCARE, ABILITY_NONE, ABILITY_DRAGONHEART },
        .innates = { ABILITY_HUBRIS},
		.innateUnlockLevel = 50,
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .backPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(56, 64) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 0 : 3,
        .backAnimId = BACK_ANIM_V_SHAKE,
    ...
    [SPECIES_LAPRAS_MEGA] =
    {
        ...
        .weight = 22000,
        .description = COMPOUND_STRING(
            "Over 50 people can ride on its\n"
    ...
    [SPECIES_DITTO] =
    {
        ...
        .abilities = { ABILITY_WONDER_SKIN, ABILITY_WONDER_SKIN, ABILITY_IMPOSTER },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Ditto"),
        .cryId = CRY_DITTO,
    ...
    [SPECIES_EEVEE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_NONE, ABILITY_ADAPTABILITY },
    #else
    ...
    [SPECIES_VAPOREON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_WATER_ABSORB, ABILITY_NONE, ABILITY_ADAPTABILITY },
		.innates = {ABILITY_PREDATOR},
		.innateUnlockLevel = 25,
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .backPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 10 : 4,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_BLUE,
    ...
    [SPECIES_JOLTEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_EARTH_EATER, ABILITY_NONE, ABILITY_ADAPTABILITY },
		.innates = {ABILITY_PREDATOR},
		.innateUnlockLevel = 25,
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_ESPEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_GALE_WINGS, ABILITY_NONE, ABILITY_ADAPTABILITY },
		.innates = {ABILITY_PREDATOR},
		.innateUnlockLevel = 25,
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_LEAFEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_GOOEY, ABILITY_NONE, ABILITY_ADAPTABILITY },
		.innates = {ABILITY_PREDATOR},
		.innateUnlockLevel = 25,
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_GLACEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ICE_SCALES, ABILITY_NONE, ABILITY_ADAPTABILITY },
		.innates = {ABILITY_PREDATOR},
		.innateUnlockLevel = 25,
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SYLVEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STRONG_JAW, ABILITY_NONE, ABILITY_ADAPTABILITY },
		.innates = {ABILITY_PREDATOR},
		.innateUnlockLevel = 25,
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
    ...
    [SPECIES_DRATINI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_NONE, ABILITY_PIXILATE },
    ...
    [SPECIES_DRAGONITE_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_DREAM_WORLD, ABILITY_NONE, ABILITY_NONE },
		.innates = { ABILITY_SOUL_HEART}, 
		.innateUnlockLevel = 50,
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Dragonite"),
        .cryId = CRY_DRAGONITE,
    ...
    [SPECIES_DRAGONITE_MEGA_Z] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_VANTABLACK, ABILITY_NONE, ABILITY_NONE },
    ...
    [SPECIES_DRATINI_BIG_CHILL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_NONE, ABILITY_MULTISCALE },
		.innates = { ABILITY_LEVITATE}, 
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Dratini"),
        .cryId = CRY_DRATINI,
        ...
        .trainerScale = 386,
        .trainerOffset = 6,
        .frontPic = gMonFrontPic_DratiniBigChill,
        .frontPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(56, 40) : MON_COORDS_SIZE(56, 48),
        .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 14 : 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_DratiniBigChill,
        .backPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 48),
        .backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 9 : 3,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = gMonPalette_DratiniBigChill,
        .shinyPalette = gMonShinyPalette_DratiniBigChill,
        .iconSprite = gMonIcon_DratiniBigChill,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(3, 3, SHADOW_SIZE_L)
        FOOTPRINT(Dratini)
    ...
    [SPECIES_DRAGONAIR_BIG_CHILL] =
    {
        ...
        .trainerScale = 411,
        .trainerOffset = 5,
        .frontPic = gMonFrontPic_DragonairBigChill,
        .frontPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 6 : 1,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
        ...
        .frontAnimId = P_GBA_STYLE_SPECIES_GFX ? ANIM_V_SHAKE : ANIM_GROW_VIBRATE,
        .backPic = gMonBackPic_DragonairBigChill,
        .backPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(56, 64) : MON_COORDS_SIZE(40, 56),
        .backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 0 : 2,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = gMonPalette_DragonairBigChill,
        .shinyPalette = gMonShinyPalette_DragonairBigChill,
        .iconSprite = gMonIcon_DragonairBigChill,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(0, 10, SHADOW_SIZE_XL_BATTLE_ONLY)
        FOOTPRINT(Dragonair)
    ...
    [SPECIES_DRAGONITE_BIG_CHILL] =
    {
        ...
        .trainerScale = 309,
        .trainerOffset = 4,
        .frontPic = gMonFrontPic_DragoniteBigChill,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 50),
        ...
        .frontAnimId = P_GBA_STYLE_SPECIES_GFX ? ANIM_V_SLIDE_SLOW : ANIM_V_SHAKE,
        .enemyMonElevation = P_GBA_STYLE_SPECIES_GFX ? 6 : 0,
        .backPic = gMonBackPic_DragoniteBigChill,
        .backPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 6 : 2,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = gMonPalette_DragoniteBigChill,
        .shinyPalette = gMonShinyPalette_DragoniteBigChill,
        .iconSprite = gMonIcon_DragoniteBigChill,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(0, 11, SHADOW_SIZE_XL_BATTLE_ONLY)
        FOOTPRINT(Dragonite)
    ...
    [SPECIES_DRAGONITE_BIG_CHILL_MEGA] =
    {
        ...
        .trainerScale = 309,
        .trainerOffset = 4,
        .frontPic = gMonFrontPic_DragoniteBigChillMega,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .frontAnimId = P_GBA_STYLE_SPECIES_GFX ? ANIM_V_SLIDE_SLOW : ANIM_V_SHAKE,
        .enemyMonElevation = P_GBA_STYLE_SPECIES_GFX ? 6 : 0,
        .backPic = gMonBackPic_DragoniteBigChillMega,
        .backPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 6 : 2,
        .backAnimId = BACK_ANIM_V_SHAKE,
