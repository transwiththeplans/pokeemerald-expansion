...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_SPRIGATITO] =
    {
        ...
        .abilities = { ABILITY_SAP_SIPPER, ABILITY_INFILTRATOR, ABILITY_SNIPER },
    ...
    [SPECIES_FUECOCO] =
    {
        ...
        .abilities = { ABILITY_EELEVATE, ABILITY_SOUNDPROOF, ABILITY_TECHNICIAN },
        ...
        .weight = 98,
        .description = COMPOUND_STRING(
            "Its vocal sac is too large, so sonic energy\n"
            "is always leaking out. This energy is\n"
            "released as sonic screams, painful to all\n"
            "those around it."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_CROCALOR] =
    {
        ...
        .weight = 307,
        .description = COMPOUND_STRING(
            "The disc atop Crocalor's head is closely\n"
            "connected to its vocal cords. It releases\n"
            "sonic wails constantly, spewing echoes in\n"
            "every direction."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_SKELEDIRGE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_COMPETITIVE, ABILITY_TECHNICIAN },
        .innates = { ABILITY_DOPPLER_EFFECT },
        .innateUnlockLevel = 25,
        .bodyColor = BODY_COLOR_RED,
        ...
        .weight = 3265,
        .description = COMPOUND_STRING(
            "The strange bird seems to multiply when\n"
            "Skeledirge sings. Entire flocks of disc-\n"
            "shaped birds gather, descending to\n"
            "overwhelm any nearby foe."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
	...
	[SPECIES_SKELEDIRGE_MEGA_Z] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_SkeledirgeMegaZ,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_SkeledirgeMegaZ,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 3,
        //.backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_SkeledirgeMegaZ,
        .shinyPalette = gMonShinyPalette_SkeledirgeMegaZ,
        .iconSprite = gMonIcon_SkeledirgeMegaZ,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(6, 7, SHADOW_SIZE_XL_BATTLE_ONLY)
        FOOTPRINT(Skeledirge)
    ...
    [SPECIES_QUAXLY] =
    {
        ...
        .abilities = { ABILITY_SCARE, ABILITY_AERILATE, ABILITY_TOXIC_CHAIN },
    ...
    [SPECIES_TAROUNTULA] =
    {
        ...
        .abilities = { ABILITY_STAKEOUT, ABILITY_SWARM, ABILITY_WEB_DOWN },
        ...
        .weight = 40,
        .description = COMPOUND_STRING(
            "The threads it produces from its rear are\n"
            "as strong as metal wire. Some wonder if\n"
            "this ability comes from the comet or from\n"
            "a deeper, unknown influence."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SPIDOPS] =
    {
        ...
        .weight = 165,
        .description = COMPOUND_STRING(
            "Female Spidops rule their nests as\n"
            "powerful queens. With precision, they\n"
            "can disguise their silk as structures\n"
    ...
    [SPECIES_NYMBLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_JUSTIFIED, ABILITY_ROCK_HEAD, ABILITY_TINTED_LENS },
        ...
        .weight = 10,
        .description = COMPOUND_STRING(
            "It excels at a parkour-like movement\n"
            "style, leaping nimbly to avoid attacks.\n"
            "It often counterattacks by smashing its\n"
            "head straight into foes."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LOKIX] =
    {
        ...
        .weight = 175,
        .description = COMPOUND_STRING(
            "Its normally folded extra legs have grown\n"
            "massive in size. This puts great strain\n"
            "on its body, forcing it to train\n"
            "constantly to remain mobile."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TANDEMAUS] =
    {
        ...
        .abilities = { ABILITY_FRIEND_GUARD, ABILITY_CUTE_CHARM, ABILITY_OWN_TEMPO },
        .innates = { ABILITY_TECHNICIAN },
        .innateUnlockLevel = 15,
        .bodyColor = BODY_COLOR_WHITE,
        ...
        .weight = 18,
        .description = COMPOUND_STRING(
            "Exhibiting strong teamwork, they burrow\n"
            "into the ground to hide from predators.\n"
            "Their bodies are formed from a curious,\n"
            "malleable material."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_MAUSHOLD_THREE] =
    {
        ...
        .weight = 23,
        .description = COMPOUND_STRING(
            "Some claim to have witnessed the smaller\n"
            "mice ‘split’ off from the main body.\n"
            "Researchers dismiss this as delusion,\n"
            "calling the witness crazy. Seek the truth."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MAUSHOLD_MEGA_Z] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_MausholdMegaZ,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .backPic = gMonBackPic_MausholdMegaZ,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 2,
        .backAnimId = BACK_ANIM_GROW_STUTTER,
        .palette = gMonPalette_MausholdMegaZ,
        .shinyPalette = gMonShinyPalette_MausholdMegaZ,
        .iconSprite = gMonIcon_MausholdMegaZ,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
        SHADOW(-1, 13, SHADOW_SIZE_L)
        FOOTPRINT(MausholdFour)
    ...
    [SPECIES_TANDEMAUS_NECROFRIGGIAN] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_METAL_MUNCHER, ABILITY_ICE_BODY, ABILITY_TECHNICIAN },
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_TandemausNecrofriggian,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 15,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_TandemausNecrofriggian,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        //.backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_TandemausNecrofriggian,
        .shinyPalette = gMonShinyPalette_TandemausNecrofriggian,
        .iconSprite = gMonIcon_TandemausNecrofriggian,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_FAST,
        SHADOW(0, -1, SHADOW_SIZE_M)
        FOOTPRINT(Tandemaus)
        ...
        .isGalarianForm = TRUE,
        .levelUpLearnset = sTandemausNecrofriggianLevelUpLearnset,
        .teachableLearnset = sTandemausNecrofriggianTeachableLearnset,
        .formSpeciesIdTable = sTandemausFormSpeciesIdTable,
		.evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_MAUSCOLD}),
    },
	    ...
	    [SPECIES_MAUSCOLD] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_METAL_MUNCHER, ABILITY_SNOW_WARNING, ABILITY_TECHNICIAN },
		.innates = {ABILITY_SNOW_SPEW},
		.innateUnlockLevel = 30,
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Mauscold"),
        .cryId = CRY_MAUSHOLD_FOUR,
        .natDexNum = NATIONAL_DEX_MAUSHOLD,
        .categoryName = _("Family"),
        .height = 3,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_Mauscold,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 15,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .frontAnimId = ANIM_H_JUMPS,
        .backPic = gMonBackPic_Mauscold,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_GROW_STUTTER,
        .palette = gMonPalette_Mauscold,
        .shinyPalette = gMonShinyPalette_Mauscold,
        .iconSprite = gMonIcon_MausholdFour,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
        SHADOW(0, -1, SHADOW_SIZE_L)
        ...
        .levelUpLearnset = sMauscoldLevelUpLearnset,
    ...
    [SPECIES_FIDOUGH] =
    {
        ...
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_AROMA_VEIL, ABILITY_SELF_SUFFICIENT },
        .innates = {ABILITY_WELL_BAKED_BODY},
        .innateUnlockLevel = 30,
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_NACLI] =
    {
        ...
        .abilities = { ABILITY_PURIFYING_SALT, ABILITY_CLEAR_BODY, ABILITY_PRISM_ARMOR },
		.innates = {ABILITY_LOOSE_ROCKS},
		.innateUnlockLevel = 40,
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Nacli"),
        .cryId = CRY_NACLI,
        ...
        .weight = 160,
        .description = COMPOUND_STRING(
            "Exposure to the comet hardened its body to\n"
            "diamond toughness. Its salt remains\n"
            "unchanged. If anything, it tastes better\n"
            "than ever."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_NACLSTACK] =
    {
        ...
        .weight = 1050,
        .description = COMPOUND_STRING(
            "The crystals on its back extend suddenly to\n"
            "catch or skewer prey. Its control over its\n"
            "elongating salt structures is incredibly\n"
            "precise."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_GARGANACL] =
    {
        ...
        .weight = 2400,
        .description = COMPOUND_STRING(
            "Garganacl sightings are rare. A possible\n"
            "connection to Gigalith has been proposed,\n"
            "but research is sparse beyond their shared\n"
            "physical features."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_CHARCADET] =
    {
        ...
        .abilities = { ABILITY_TRACE, ABILITY_NONE, ABILITY_RATTLED },
    ...
    [SPECIES_ARMAROUGE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_TIME_WARP, ABILITY_NONE, ABILITY_CHROME_COAT },
		.innates = {ABILITY_BATTLE_ARMOR},
		.innateUnlockLevel = 40,
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_CERULEDGE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_MOXIE, ABILITY_NONE, ABILITY_WEAK_ARMOR },
		.innates = {ABILITY_BATTLE_ARMOR},
		.innateUnlockLevel = 40,
    ...
    [SPECIES_TADBULB] =
    {
        ...
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_STATIC, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_BELLIBOLT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_ELECTROMORPHOSIS, ABILITY_STATIC, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_BRAMBLIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_LEAF_GUARD, ABILITY_INFILTRATOR, ABILITY_SEED_SOWER },
		.innates = { ABILITY_SEED_DISPERSAL}, 
		.innateUnlockLevel = 40,
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .weight = 6,
        .description = COMPOUND_STRING(
            "It is said to have sprouted from nowhere.\n"
            "Seeds grow inside its body and are fired\n"
            "at predators with surprising force when\n"
            "it is forced to flee."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BRAMBLEGHAST] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_ROOTED, ABILITY_INFILTRATOR, ABILITY_SEED_SOWER },
		.innates = { ABILITY_SEED_DISPERSAL}, 
		.innateUnlockLevel = 40,
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .weight = 60,
        .description = COMPOUND_STRING(
            "It opens the branches atop its head to\n"
            "ensnare prey. Once trapped, victims find\n"
            "themselves unable to escape the tangle of\n"
            "brambles and roots."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_TOEDSCOOL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_UNBURDEN, ABILITY_LIMBER, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_KLAWF] =
    {
        ...
        .abilities = { ABILITY_ANGER_SHELL, ABILITY_SHELL_ARMOR, ABILITY_TOUGH_CLAWS },
        .innates = {ABILITY_REGENERATOR},
        .innateUnlockLevel = 40,
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Klawf"),
    ...
    [SPECIES_RELLOR] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_COMPOUND_EYES, ABILITY_RUN_AWAY, ABILITY_SELF_SUFFICIENT },
    ...
    [SPECIES_RABSCA] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_LEVITATE, ABILITY_MAGIC_BOUNCE, ABILITY_SELF_SUFFICIENT },
		.innates = {ABILITY_BULLETPROOF},
		.innateUnlockLevel = 30,
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_TINKATINK] =
    {
        ...
        .abilities = { ABILITY_LIGHTNING_ROD, ABILITY_REFRACTION, ABILITY_WEAK_ARMOR },
    ...
    [SPECIES_TINKATUFF] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_SHINY_STONE, SPECIES_TINKATON}),
    },
    ...
    [SPECIES_WIGLETT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_MOXIE, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_FINIZEN] =
    {
        ...
        .abilities = { ABILITY_WATER_VEIL, ABILITY_FIREPOWER, ABILITY_IRON_FIST },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_VAROOM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_BULLETPROOF, ABILITY_COUNTERPROOF, ABILITY_FILTER },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_CYCLIZAR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_REAPER_CLOTH, SPECIES_KORAIDON},
                                {EVO_ITEM, ITEM_METAL_COAT, SPECIES_MIRAIDON}),
    },
    ...
    [SPECIES_GLIMMET] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_TOXIC_DEBRIS, ABILITY_NONE, ABILITY_PERISH_BODY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CETODDLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INNARDS_OUT, ABILITY_ICE_BODY, ABILITY_SLUSH_RUSH },
    ...
    [SPECIES_VELUZA] =
    {
        ...
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_NONE, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_FRIGIBAX] =
    {
        ...
        .abilities = { ABILITY_LIGHTNING_ROD, ABILITY_NONE, ABILITY_HEATPROOF },
    ...
    [SPECIES_ARCTIBAX] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 50, SPECIES_BAXCALIBUR}),
    },
    ...
    [SPECIES_KORAIDON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_CURSED_BODY, ABILITY_CONTRARY, ABILITY_INNARDS_OUT },
		.innates = {ABILITY_DRAGONS_MAW},
		.innateUnlockLevel = 55,
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_MIRAIDON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_FILTER, ABILITY_IRON_BARBS, ABILITY_BULLETPROOF },
		.innates = {ABILITY_DRAGONS_MAW},
		.innateUnlockLevel = 55,
        .bodyColor = BODY_COLOR_PURPLE,
