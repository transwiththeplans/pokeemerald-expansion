...
extern const u8 BattleScript_PredatorActivate[];
...
extern const u8 BattleScript_ShootingStarActivates[];
...
extern const u8 BattleScript_ScarePrevented[];
extern const u8 BattleScript_ScareInReverse[];
...
extern const u8 BattleScript_DeadSpaceActivates[];
extern const u8 BattleScript_DeadSpaceActivatesRet[];
...
extern const u8 BattleScript_WindBlowerActivates[];
extern const u8 BattleScript_ScareActivates[];
extern const u8 BattleScript_ScarePrevented[];
...
extern const u8 BattleScript_AirborneMsgIn[];
extern const u8 BattleScript_AirborneMsgInRet[];
extern const u8 BattleScript_AirborneBroken[];
...
extern const u8 BattleScript_TyphoonActivates[];
...
extern const u8 BattleScript_DeadSpaceExits[];
...
extern const u8 BattleScript_SnowSpewActivates[];
extern const u8 BattleScript_ScareEffect[];
extern const u8 BattleScript_TimeDistortActivates[];
extern const u8 BattleScript_SelfSufficientHeal[];
...
extern const u8 BattleScript_BattlerAbilityChemist_ConfusionResisted[];
extern const u8 BattleScript_BattlerAbilityChemist_InfatuationResisted[];
extern const u8 BattleScript_BattlerAbilityChemist_TauntResisted[];
extern const u8 BattleScript_BattlerAbilityChemist_TormentResisted[];
...
extern const u8 BattleScript_BattlerAbilityChemist_Confusion[];
extern const u8 BattleScript_BattlerAbilityChemist_Infatuation[];
extern const u8 BattleScript_BattlerAbilityChemist_Taunt[];
extern const u8 BattleScript_BattlerAbilityChemist_Torment[];
