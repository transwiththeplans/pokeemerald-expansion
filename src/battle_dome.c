...
static int GetTypeEffectivenessPoints(int move, int targetSpecies, int mode)
{
    ...
    if ((defAbility == ABILITY_LEVITATE || SpeciesHasInnate(targetSpecies, ABILITY_LEVITATE) || defAbility == ABILITY_EELEVATE || SpeciesHasInnate(targetSpecies, ABILITY_EELEVATE)) && moveType == TYPE_GROUND)
    {
