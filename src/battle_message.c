...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_DREAMWORLDMESSAGE]                    = COMPOUND_STRING("An strange force made everybody feel drowsy!"),
    ...
    [STRINGID_SHOOTINGSTARTACTIVATED]               = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} made a Wish!"), //not in gen 5+, ability popup
    ...
    [STRINGID_DEADSPACEENTERS]                      = COMPOUND_STRING("A suffocating void smothers the battlefield!"),
    [STRINGID_DEADSPACEOVER]                        = COMPOUND_STRING("The suffocating void faded away!"),
    ...
    [STRINGID_THERIANTROPEREACTING]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX2} is remembering its original shape!"),
    ...
    [STRINGID_CHEMIST_ACTIVATION_CONFUSION_RESISTED] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} resisted the confusing gas!"),
    [STRINGID_CHEMIST_ACTIVATION_INFATUATION_RESISTED] = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} resisted the alluring gas!"),
    [STRINGID_CHEMIST_ACTIVATION_TAUNT_RESISTED]    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} resisted the taunting gas!"),
    [STRINGID_CHEMIST_ACTIVATION_TORMENT_RESISTED]  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} resisted the tormenting gas!"),
    [STRINGID_CHEMIST_ACTIVATION_POISON]            = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} became poisoned due to the gas!"),
    [STRINGID_CHEMIST_ACTIVATION_SLEEP]             = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} fell asleep due to the gas!"),
    ...
    [STRINGID_CHEMIST_ACTIVATION_CONFUSION]         = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} became confused due to the gas!"),
    [STRINGID_CHEMIST_ACTIVATION_INFATUATION]       = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} became infatuated due to the gas!"),
    [STRINGID_CHEMIST_ACTIVATION_TAUNT]             = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} fell for the gas's taunt!"),
    [STRINGID_CHEMIST_ACTIVATION_TORMENT]           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was tormented by the gas!"),
...
const u16 gFutureMoveUsedStringIds[] =
{
    ...
    [B_MSG_GLIMMER_GATE] = STRINGID_PKMNFORESAWATTACK
};
